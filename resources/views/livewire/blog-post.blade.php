        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-8">
                @if($post->hasMedia('cover'))
                    <img src="{{ $post->getFirstMediaUrl('cover') }}" alt="{{ $post->translated_title }}" width="1200" height="384" fetchpriority="high" class="w-full h-96 object-cover rounded-lg shadow-lg">
                @endif
            </div>
